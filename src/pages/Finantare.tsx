...
export default function Finantare() {
  ...
  useEffect(() => {
    const handleError = (error: ErrorEvent) => {
      console.error('Finantare page error:', error);
      setHasError(true);
    };
          ...
          <Container>
            <div className="text-center space-y-6">
              <Alert variant="destructive">
                <AlertDescription>
                  A apărut o eroare la încărcarea paginii. Vă rugăm să reîncercați.
                </AlertDescription>
              </Alert>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Form Only - Removed Calculator to prevent infinite loops */}
      <Section>
        <Container>
